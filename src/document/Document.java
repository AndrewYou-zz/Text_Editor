...
public abstract class Document {
	...
	public double getFleschScore()
	{
	    ...
	    double firstConstant = 1.015; 
	    double secondConstant = 84.6; 
	    double leadConstant = 206.835; 
	    double firstTerm = firstConstant*(numWords/numSentences); 
	    double secondTerm = secondConstant*(numSyllables/numWords); 
	    double FleschScore = leadConstant - firstTerm - secondTerm; 
	    return FleschScore; 
