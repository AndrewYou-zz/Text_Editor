...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			double elapsedTimeBasic = ((endTimeBasic - startTimeBasic)/1000000000.0); 
			System.out.print(elapsedTimeBasic + "\t");
			...
			double elapsedTimeEfficient = ((endTimeEfficient - startTimeEfficient)/1000000000.0); 
			System.out.print(elapsedTimeEfficient + "\n");
		}
